    ...
    <table class="tableau">
            ...
            <tr>
                ...
                <asp:ImageButton ID="imgBtnCalendrier" ImageUrl="~/App_Themes/Default/images/btnCalendrier.png" runat="server" CausesValidation="false" />              
                    ...
                    <asp:RangeValidator ID="rangeValidatorDateNaissance" Type="Date" runat="server" ErrorMessage="La date de naissance doit précéder la date d'aujourd'hui." ControlToValidate="tbDateNaissance" Display="Dynamic" ForeColor="Red">*</asp:RangeValidator>
                    </td>
            </tr>
            <tr>
