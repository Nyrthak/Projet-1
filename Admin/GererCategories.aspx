<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/masterPage.master" CodeFile="GererCategories.aspx.vb" Inherits="Admin_GererCategories" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvNom" ForeColor="Red" runat="server" Display="Dynamic"
                            ErrorMessage="Le nom de la catégorie doit être spécifié." ControlToValidate="tbNom" ValidationGroup="Edit">*
            ...
            <InsertItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbNom" runat="server" Text='<%#Bind("Nom")%>' SkinID="tbSkin" Width="80px" MaxLength="15"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvNom" ForeColor="Red" runat="server" Display="Dynamic"
                            ErrorMessage="Le nom de la catégorie doit être spécifié." ControlToValidate="tbNom" ValidationGroup="Insert">*
                        </asp:RequiredFieldValidator>
                    </td>
