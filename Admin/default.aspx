<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/masterPage.master" CodeFile="default.aspx.vb" Inherits="Admin_ajouterComptePrepose" %>
            ...
            <tr>
                ...
                <asp:ImageButton ID="imgBtnCalendrier" ImageUrl="~/App_Themes/Default/images/btnCalendrier.png" runat="server" CausesValidation="false" />              
                    <asp:RequiredFieldValidator SkinID="requisValidation" 
                        ...
                        ControlToValidate="tbDateNaissance" Display="Dynamic" Type="Date" ForeColor="Red">*</asp:RangeValidator>
