        ...
        <asp:ListView ID="lViewAnimateurs" runat="server" DataSourceID="entiDataSourceAnimateurs" DataKeyNames="noAnimateur" InsertItemPosition="LastItem">
            ...
            <SelectedItemTemplate>
                ...
                <tr>
                    ...
                    <td class="tdCentre"><asp:Label ID="lbNom" runat="server" Text='<%#Eval("Nom")%>'></asp:Label></td>
                    <td colspan="2" class="tdCentre tdDroite"><asp:Label ID="lbDatenaissance" runat="server" Text='<%#Eval("DateNaissance", "{0:dd/MM/yyyy}")%>'></asp:Label></td>
                </tr>
                <tr>
                    ...
                    <td class="tdCentre"><asp:Label ID="lbTitreCodePostal" runat="server" Text="CodePostal" SkinID="lbChampsFormulaire"></asp:Label></td>
                    <td class="tdCentre"><asp:Label ID="lbTitreVille" runat="server" Text="Ville" SkinID="lbChampsFormulaire"></asp:Label></td>
                ...
                <tr>
                    ...
                    <td class="tdCentre"><asp:Label ID="lbCodePostal" runat="server" Text='<%#Eval("CodePostal")%>'></asp:Label></td>
                    <td class="tdCentre"><asp:Label ID="lbVille" runat="server" Text='<%#Eval("Ville")%>'></asp:Label></td>
                ...
                <tr>
                    <td colspan="2" class="tdGauche tdBas"><asp:Label ID="lbAdresse" runat="server" Text='<%#Eval("Adresse")%>'></asp:Label></td>
                    <td colspan="2" class="tdDroite tdBas" style="text-align:right;">
                        <asp:Button ID="btnEdit" runat="server" Text="Modifier" CommandName="Edit" SkinID="btnAjoutSupprimer" />
                        <asp:Button ID="btnCancel" runat="server" Text="Annuler" CommandName="AnnulerSelect" SkinID="btnAjoutSupprimer" />
                        <asp:Button ID="btnDelete" runat="server" Text="Supprimer" CommandName="Delete" SkinID="btnAjoutSupprimer" />
                    </td>
                </tr>
                <tr style="height:25px;"></tr>
            </SelectedItemTemplate>
            <EditItemTemplate>
                ...
                <tr>
                    ...
                    <td class="tdDroite">
                        ...
                        <asp:CustomValidator ID="customVProvince" runat="server" ErrorMessage="La province doit être spécifiée."
                            ForeColor="Red" ValidationGroup="Edit" ControlToValidate="dDListProvince" 
                            Display="Dynamic" OnServerValidate="customV_province">*</asp:CustomValidator>
                    </td>
                </tr>
                <tr>
            ...
            <InsertItemTemplate>
                ...
                <tr>
                    ...
                    <td class="tdDroite">
                        ...
                        <%--<asp:CompareValidator ID="cvProvince" runat="server" Type="String" ControlToValidate="dDListProvince"
                            ErrorMessage="PROVINCE!!!!" ForeColor="Red" ValueToCompare=""
                            Operator="NotEqual" Display="Dynamic" ValidationGroup="Insert">*
                        </asp:CompareValidator>--%>
                        <%--<asp:CustomValidator ID="customVProvince" runat="server" ErrorMessage="La province doit être spécifiée."
                            ForeColor="Red" ValidationGroup="Insert" ControlToValidate="dDListProvince" 
                            Display="Dynamic" OnServerValidate="customV_province">*</asp:CustomValidator>--%>
                    </td>
                </tr>
                <tr>
